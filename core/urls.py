...
urlpatterns = [
    ...
    path('comms/channels/<slug:slug>/delete/', views.channel_delete, name='channel_delete'),
    ...
    path('comms/projects/<int:pk>/edit/', views.project_edit, name='project_edit'),
    ...
    path('comms/projects/<int:pk>/activity/post/', views.project_post_update, name='project_post_update'),
    path('comms/projects/<int:project_pk>/milestones/add/', views.milestone_add, name='milestone_add'),
    ...
    path('tasks/<int:pk>/', views.standalone_task_detail, name='standalone_task_detail'),
